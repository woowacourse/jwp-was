...
import controller.HandlerAdapter;
...
public class RequestHandler implements Runnable {
    ...
    public RequestHandler(Socket connectionSocket, HandlerMapping handlerMapping) {
        ...
        this.handlerAdapter = HandlerAdapter.of(handlerMapping);
    }
    ...
    public void run() {
        ...
        try (InputStream in = connection.getInputStream(); OutputStream out = connection.getOutputStream()) {
            ...
            final Controller controller = handlerAdapter.find(httpRequest.getUrl());
