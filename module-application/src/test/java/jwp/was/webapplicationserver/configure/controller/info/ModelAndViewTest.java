...
class ModelAndViewTest {
    ...
    void toHttpResponse_ExistsFile_ReturnOk() {
        ...
        Assertions.assertThat(httpResponse.getHttpStatusCode()).isEqualTo(HttpStatusCode.OK);
        Assertions.assertThat(httpResponse.getHttpVersion())
            .isEqualTo(httpRequest.getHttpVersion());
        Assertions.assertThat(httpResponse.getBody()).contains(user1.getName().getBytes());
        Assertions.assertThat(httpResponse.getBody()).contains(user2.getEmail().getBytes());
        Assertions.assertThat(httpResponse.getHeaders().get(CONTENT_TYPE))
    ...
    void toHttpResponse_NotExistsFile_ReturnNotFound() {
        ...
        Assertions.assertThat(httpResponse.getHttpStatusCode()).isEqualTo(HttpStatusCode.NOT_FOUND);
        Assertions.assertThat(httpResponse.getHttpVersion())
            .isEqualTo(httpRequest.getHttpVersion());
        Assertions.assertThat(httpResponse.getBody()).doesNotContain(user1.getName().getBytes());
        Assertions.assertThat(httpResponse.getBody()).doesNotContain(user2.getEmail().getBytes());
        Assertions.assertThat(httpResponse.getHeaders().get(CONTENT_TYPE))
