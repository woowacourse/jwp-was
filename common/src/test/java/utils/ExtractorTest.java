...
class ExtractorTest {
    ...
    void sessionIdFromCookie() {
        String cookie = String.format("Idea-9e315a38=2ca897d9-c5e6eb82697ff0; _ga=GA1.1.132160; %s=1234", sessionKey);

        String sessionId = Extractor.sessionIdFrom(cookie, sessionKey).get();
    ...
    void sessionIdFromCookieWhenNotFoundSessionId() {
        ...
        Optional<String> sessionId = Extractor.sessionIdFrom(cookie, sessionKey);
