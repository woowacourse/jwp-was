...
class HttpResponseTest {
    ...
    void responseForward() throws Exception {
        ...
        Path path = Paths.get(HttpResponseTest.class.getClassLoader().getResource(filePath).toURI());
        byte[] body = Files.readAllBytes(path);
        response.setHttpStatus(HttpStatus.OK);
        response.addHeader(HttpHeader.CONTENT_TYPE,
            String.format("text/%s;charset=utf-8", RequestUtils.extractExtension(filePath)));
    ...
    private OutputStream createOutputStream(String filename) throws FileNotFoundException {
        String testDirectory = "/Users/sangbo/Projects/woowa/jwp-was/framework/module-webserver/src/test/resources/";
