...
public class RouterConfigFile extends RouterConfig {
    private static final String ROUTER_CONFIG_FILE_PATH = "./router-config.json";

    protected static Optional<RouterConfigFile> init() {
        ...
        }).map(RouterConfigFile::new);
    }

    private RouterConfigFile(Map<HttpMethod, Pathfinder> matchers) {
        super(matchers);
    }
}