...
public abstract class AbstractController implements Controller {
    ...
    public void service(Request request, Response response) throws
            IOException,
            URISyntaxException,
            NoSuchMethodException, IllegalRequestException {
    ...
    public abstract void doPost(Request request, Response response) throws NoSuchMethodException, IllegalRequestException;
}
