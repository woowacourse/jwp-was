...
public class RequestLineTest {
    ...
    void constructor_NullAndEmpty_ThrownException(String input) {
        Assertions.assertThatThrownBy(() -> new RequestLine(input)).isInstanceOf(NotExistRequestHeader.class);
    }
    ...
    void constructor_NegativeSize_ThrownException(String input) {
        Assertions.assertThatThrownBy(() -> new RequestLine(input))
    ...
    void getMethod(String input, String expected) {
        ...
        Assertions.assertThat(requestLine.getMethod()).isEqualTo(expected);
    }
    ...
    void extractResourcePath(String input, String expected) {
        RequestLine requestLine = new RequestLine(input);
        Assertions.assertThat(requestLine.getPath()).isEqualTo(expected);
    }
}
