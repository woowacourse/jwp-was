...
public class HttpMethodTest {
    ...
    void isSupported(String httpMethod, boolean expected) {
        Assertions.assertThat(HttpMethod.find(httpMethod).isSupport()).isEqualTo(expected);
    }
    ...
    void hasBody(String httpMethod, boolean expected) {
        Assertions.assertThat(HttpMethod.hasBody(httpMethod)).isEqualTo(expected);
    }
    ...
    void isSame() {
        ...
        Assertions.assertThat(HttpMethod.find(httpMethod).isSame("GET")).isTrue();
    }
    ...
    void find_NotExistHttpMethod_ThrownException() {
        ...
        Assertions.assertThat(HttpMethod.find(httpMethod)).isNull();
    }
}
